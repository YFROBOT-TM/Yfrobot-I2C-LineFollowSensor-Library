...
const byte lineSensor6 = 5; // ir sensor to SX1508's pin 5
const byte lineSensor7 = 6; // ir sensor to SX1508's pin 6
...
void loop()
{
  ...
  uint8_t ls6 = YFLS.readSensor(lineSensor6);
  uint8_t ls7 = YFLS.readSensor(lineSensor7);
  Serial.print(ls1);
  Serial.print("  ");
  Serial.print(ls2);
  Serial.print("  ");
